...
const Mentee = () => {
  ...
  return (
    <div className='p-4'>
      <Navbar />
      <div className="p-10 min-h-screen bg-blue-100">
        <div className="py-12 px-4 text-center">
          ...
          <div>
            <div className='flex py-3'>
              <hr className="w-1/4 h-1 bg-gradient-to-r from-blue-400 to-lightGreen-500" />
            </div>
            <div align='right'>
              <hr className="w-1/4 h-1 bg-gradient-to-l from-blue-400 to-lightGreen-500 self-end" />
            </div>
          </div>
          <motion.h1
            ...
            >
              ...
              <div className="flex flex-wrap">
                {matchedSkills.map((skill) => (
                  <span key={skill} className="bg-blue-500 text-white px-3 py-1 rounded-lg mr-2 mb-2">
                    {skill}
                  </span>
                ))}
              </div>
